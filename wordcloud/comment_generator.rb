...
class CommentGenerator
  NEW_CLOUD_URL = "https://raw.githubusercontent.com/trinib/word-cloud/main/previous_clouds/#{CloudTypes::CLOUDLABELS[-2]}_cloud#{CloudTypes::CLOUDLABELS.size - 1}.png"
  ADDWORD = 'add'
